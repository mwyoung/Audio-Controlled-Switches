...
//transmission channel: 76=OK
#define NRF24L01_CH 0 

//payload lenght
#define NRF24L01_PAYLOAD 2 

//auto ack enabled
#define NRF24L01_ACK 0 

//auto retransmit delay and count (1500us, 15 times)
#define NRF24L01_RETR (0b0100 << NRF24L01_REG_ARD) | (0b0111 << NRF24L01_REG_ARC) 
